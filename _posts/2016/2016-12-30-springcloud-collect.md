...
> 学习 Spring Cloud 首先需要了解 Spring Boot，不了解 Spring Boot 的同学戳这里[Spring Boot学习资料汇总](http://www.javaai.club/springboot/2015/12/30/springboot-collect.html)
...
- [廖权名 Spring Cloud 系列文章](http://www.javaai.club/spring-cloud) 
...
- [廖权名的 Spring Cloud 示例](https://github.com/ityouknow/spring-cloud-examples)  
