...
#这里的配置表示，访问/it/** 直接重定向到http://www.javaai.club/**
zuul.routes.baidu.path=/it/**
zuul.routes.baidu.url=http://www.javaai.club/
```
...
启动```gateway-service-zuul-simple```项目，在浏览器中访问：```http://localhost:8888/it/spring-cloud```，看到页面返回了：```http://www.javaai.club/spring-cloud ``` 页面的信息，如下：
...
-------------
**作者：廖权名**  
**出处：[http://www.javaai.club/](http://www.javaai.club/springcloud/2017/06/01/gateway-service-zuul.html)**      
**版权归作者所有，转载请注明出处** 
