...
<html lang="zh" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <a href="#" th:href="@{ http://www.javaai.club/neo/{id}(id=${id}) }">激活账号</a>
    </body>
</html>
```
...
可以参考前期文章：[Spring Boot(八)：RabbitMQ 详解](http://www.javaai.club/springboot/2016/11/30/spring-boot-rabbitMQ.html) 来实现。
