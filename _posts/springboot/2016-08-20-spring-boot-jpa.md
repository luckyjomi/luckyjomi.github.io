...
在上篇文章[Spring Boot(二)：Web 综合开发](http://www.javaai.club/springboot/2016/02/03/spring-boot-web.html)中简单介绍了一下 Spring Boot Jpa 的基础性使用，这篇文章将更加全面的介绍 Spring Boot Jpa 常见用法以及注意事项。
